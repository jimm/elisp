(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window ag alchemist avy crystal-mode diminish fzf inf-ruby magit markdown-mode org-present projectile projectile-rails py-isort python-black rubocop rubocopfmt slime smex yaml-mode yasnippet yasnippet-snippets))
