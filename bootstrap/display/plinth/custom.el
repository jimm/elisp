(custom-set-variables
 ...
 '(package-selected-packages
   '(rust-mode wordel edit-indirect cypher-mode typescript-mode rspec-mode projectile-rails lua-mode git-commit malyon swift-mode kotlin-mode dockerfile-mode 2048-game ace-window ag alchemist avy crystal-mode diminish fzf inf-ruby magit markdown-mode org-present projectile py-isort python-black rubocop rubocopfmt slime smex yaml-mode yasnippet yasnippet-snippets))
 '(python-fill-docstring-style 'pep-257-nn)
 '(safe-local-variable-values
   '((*prevent-ruby-formatting*)
     (*prevent-ruby-formatting* . t)
     (*prevent-python-formatting*)
