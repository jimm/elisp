(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (graphviz-dot-mode clojure-mode swift-mode coffee-mode typescript-mode 2048-game projectile edit-indirect ox-jira pyvenv erlang crystal-mode docker docker-compose-mode dockerfile-mode org-present htmlize pyenv-mode go-mode groovy-mode yaml-mode editorconfig ace-window ag alchemist avy diminish flx-ido fzf magit markdown-mode sicp slime smex suggest yasnippet yasnippet-snippets)))
