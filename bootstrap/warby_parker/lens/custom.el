(custom-set-variables
 ...
 '(package-selected-packages
   '(py-isort python-black fzf rust-mode exec-path-from-shell http-twiddle jade-mode lua-mode elm-mode rjsx-mode js2-mode graphviz-dot-mode clojure-mode swift-mode coffee-mode typescript-mode 2048-game projectile edit-indirect pyvenv erlang crystal-mode docker docker-compose-mode dockerfile-mode org-present htmlize pyenv-mode go-mode groovy-mode editorconfig ace-window ag alchemist avy diminish flx-ido magit markdown-mode sicp slime smex suggest yasnippet yasnippet-snippets))
