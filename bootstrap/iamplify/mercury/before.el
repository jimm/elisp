...
(add-to-list 'load-path "/usr/share/emacs/21.1/lisp" t)
(add-to-list 'load-path "/usr/share/emacs/21.1/site-lisp" t)
...
(defvar *my-sql-regex*
  ...
  "See function my-sql-send-paragraph.")
(defvar *my-sql-regex-replacement* "\\1_dev_jimm."
  "See function my-sql-send-paragraph.")
