...
I use ELPA, the Emacs Lisp Package Archive (http://tromey.com/elpa/), but
don't check that directory into this repository.
...
See also http://www.jimmenard.com/emacs_tips.html.
