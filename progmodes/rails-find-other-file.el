...
(defun rails-features-dir (path)
  (concat (rails-root-dir path) "features/"))
...
(add-hook 'ruby-mode-hook
          (lambda ()
            (define-prefix-command 'rails-find-other-file-map)
            (local-set-key "\C-cg" 'rails-find-other-file-map)
            (define-key rails-find-other-file-map "c" 'rails-find-controller)
            (define-key rails-find-other-file-map "f" 'rails-find-feature)
            (define-key rails-find-other-file-map "g" 'rails-find-config)
            (define-key rails-find-other-file-map "h" 'rails-find-helper)
            (define-key rails-find-other-file-map "j" 'rails-find-javascript)
            (define-key rails-find-other-file-map "l" 'rails-find-lib)
            (define-key rails-find-other-file-map "m" 'rails-find-model)
            (define-key rails-find-other-file-map "s" 'rails-find-spec)
            (define-key rails-find-other-file-map "t" 'rails-find-test)
            (define-key rails-find-other-file-map "v" 'rails-find-view)
            (define-key rails-find-other-file-map "x" 'rails-find-fixture)
            (define-key rails-find-other-file-map "y" 'rails-find-stylesheet)))
